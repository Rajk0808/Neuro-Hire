...
from apps.backend.app.agents.Resume_Intelligence_agent.database.schemas.neo4j_schema import *
load_dotenv()  
...
also if a field is not present in the input text, return it as None instead of an empty list, dictionary or dictionary with none values.
example output:
{{
    "candidate": {{
        "name": "John Doe",
...
Do not Make this Mistakes:     

input :  'Candidates with PyTorch experience at e-commerce companies'
expected output: {{
    "candidate": None,
    "education": None,         
    "skills": [
...
actual output: {{
    'candidate': None, 'education': None, 'skills': None, 'company': None, 'industry': None, 'role': None
    }}                                                                                                                                                                                                                                                                                
""")
