...
-- ============================================
-- AGENT
-- Stores execution state for a job application
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_agents_application
ON agents(application_id);
        """)
        return True
    except Exception as e:
