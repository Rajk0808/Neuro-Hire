...
from agents.Resume_Intelligence_agent.services.ingestion_services.extractor.orchestrator import ResumeOrchestrator, ExtractionMode
from custom_llm.EmbeddingHuggingFace import QwenMultimodalEmbeddingFunction
from agents.Resume_Intelligence_agent.services.ingestion_services.extractor.run import text_extraction 
...
from agents.Resume_Intelligence_agent.services.ingestion_services.modeling.neo4j_modeling import Neo4jModeling
from agents.Resume_Intelligence_agent.database.ops.Neo4j_insertion import insert_to_neo4j
import logging
import nltk
...
class Ingestion:
    ...
    def ingest_to_opensearch(self, StateGraph: IngestionGraph):
        ...
        try:
            ...
            index_name = StateGraph.get("index_name", "resumes") if isinstance(StateGraph, dict) else StateGraph.index_name
